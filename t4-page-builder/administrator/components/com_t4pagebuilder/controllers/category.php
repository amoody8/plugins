 ...
 * @since  1.6
 */
class T4pagebuilderControllerCategory extends JControllerForm
{
	/**
	...
	public function __construct($config = array())
	{
		...
		{
			$this->extension = $this->input->get('extension', 'com_t4pagebuilder');
		}
	}
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect('index.php?option=com_t4pagebuilder&view=categories&extension=' . $this->extension);
