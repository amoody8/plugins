...
<form action="<?php echo JRoute::_('index.php?option=com_t4pagebuilder&extension=' . $input->getCmd('extension', 'com_t4pagebuilder') . '&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
