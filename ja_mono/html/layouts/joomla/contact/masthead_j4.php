...
$item = $displayData['item']->get('contact');
$tpl = $displayData['item'];
?>
<div class="jamasthead blend-bg contact" >
    <div class="jamasthead-detail plain-contact"><div class="plain-style">
      ...
      <div class="col-xs-12 contact-top">
        <?php if ($item->image && $params->get('show_image')) : ?>
      ...
      <div class="col-xs-12 contact-information">
        <div class="inner"> 
          <!-- Show Contact name -->
          <?php if ($item->name && $item->params->get('show_name')) : ?>
          ...
          <div class="box-contact"> 
            <!-- Contact links -->
            <?php echo $tpl->loadTemplate('links'); ?>
            <!-- End contact Links -->
          </div>
          ...
          <div class="box-contact"> 
            ...
            <?php if ($item->con_position && $params->get('show_position')) : ?>
            ...
            <?php echo $tpl->loadTemplate('address'); ?>
