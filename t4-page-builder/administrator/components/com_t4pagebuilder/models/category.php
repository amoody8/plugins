 ...
 * @since  1.6
 */
class T4pagebuilderModelCategory extends JModelAdmin
{
	/**
	...
	public function __construct($config = array())
	{
		...
		$extension = JFactory::getApplication()->input->get('extension', 'com_t4pagebuilder');
	...
	protected function populateState()
	{
		...
		$extension = $app->input->get('extension', 'com_t4pagebuilder');
	...
	/**
	 * Custom clean the cache of com_t4pagebuilder and content modules
	 *
	...
	protected function cleanCache($group = null, $client_id = 0)
	{
		...
		switch ($extension)
		{
			case 'com_t4pagebuilder':
				parent::cleanCache('com_t4pagebuilder');
