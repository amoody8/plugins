 ...
 * @since  1.6
 */
class T4pagebuilderModelCategories extends JModelList
{
	/**
	 * Constructor.
	 *
	 ...
	 */
	public $_context = 'com_t4pagebuilder.categories';
	 ...
	 * @var		string
	 */
	protected $_extension = 'com_t4pagebuilder';
	...
	protected function populateState($ordering = 'a.lft', $direction = 'asc')
	{
		...
		$extension = $app->getUserStateFromRequest($this->context . '.filter.extension', 'extension', 'com_t4pagebuilder', 'cmd');
