...
<div class="logout <?php echo $this->pageclass_sfx?>">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.logout'); ?>" method="post" class="form-horizontal">
		<div class="control-group">
			<div class="controls">
				<button type="submit" class="btn-flip-wrap">
					<span class="btn btn-lg btn-border btn-flip-front"><?php echo JText::_('JLOGOUT'); ?></span>
					<span class="btn btn-lg btn-inverse btn-flip-back"><?php echo JText::_('TPL_MESSAGE_LOGOUT'); ?></span>
				</button>
			</div>
		</div>
