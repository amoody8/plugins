...
if($this->params->get('presentation_style') == 'plain') {
  ...
  if (version_compare(JVERSION, '4.0') >= 0) {
		$masthead = JLayoutHelper::render('joomla.contact.masthead_j4', array('item' => $this, 'params' => $params));
		} else if (version_compare(JVERSION, '3.3.0') >= 0) {
			$masthead = JLayoutHelper::render('joomla.contact.masthead', array('item' => $this, 'params' => $params));
	}
...
<div class="contact<?php echo $this->pageclass_sfx?>" itemscope itemtype="http://schema.org/Person">
	...
	<div class="row <?php echo $this->params->get('presentation_style') ?>-style">
		...
		<div class="col-md-12 col-sm-12 contact-form">
			<?php  echo '<h3>'. JText::_('TPL_YOU_NEED_HELP').'</h3>';  ?>
