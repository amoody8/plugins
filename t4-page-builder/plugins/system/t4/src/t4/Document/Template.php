...
class Template
{
    ...
    {
        return \JLayoutHelper::render('t4.layout.offcanvas', $this, T4PATH . '/layouts');
    }
    public function getLogoedit()
    {
        \T4\Document\Edit::loadTypelistData();
        $doc = $this->doc;
    ...
    public function renderSection($data)
    {
        ...
        return LayoutHelper::render('t4.layout.section', ['data' => $data, 'content' => $content], T4PATH . '/layouts');
    }
