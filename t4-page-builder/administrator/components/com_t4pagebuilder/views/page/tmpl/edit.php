...
if (!defined('JPB_LOADER')) {
    ...
    $doc->addScriptDeclaration('var ajax_url="' . $ajaxUrl . '";var loadgooglefont=' . $loadgooglefont . ';var customFont=' . json_encode($customFonts) . '; var site_root_url = "' . \JUri::root() . '"; var loadIcons = ' . json_encode($loadIcons) . '; var builder_url = "' . $t4base . '";var builderParam="' . JPB_PARAM . '";var jpb_devmode="'.JPB_DEVMODE.'";var isT4 ="'.$this->isT4.'";');
    $doc->addScript($t4base . 'js/loader.js');
    $doc->addScript(JPB_PATH_BASE . 'assets/js/t4pagebuilder.js');
    $doc->addStyleSheet(JUri::base(true) .  "/components/com_t4pagebuilder/assets/css/googlefonts.css");
    $doc->addStylesheet(\JUri::root(true). JPB_MEDIA_BUILDER . 'css/fontawesome_light.css');
